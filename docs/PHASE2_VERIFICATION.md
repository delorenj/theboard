...
- Database: postgresql://delorenj:Ittr5eesol@localhost:5432/theboard
- RabbitMQ: amqp://delorenj:Ittr5eesol@localhost:5673/
- Event emitter: rabbitmq

**Consumer Configuration**:
- Queue: theboard_meeting_trigger_queue
- Database: postgresql://delorenj:Ittr5eesol@localhost:5432/theboard (local PostgreSQL)
- RabbitMQ: amqp://delorenj:Ittr5eesol@localhost:5673/
...
5. **Database Credentials**: Consumer now uses correct PostgreSQL credentials (delorenj:Ittr5eesol)
...
Publish test event:
```bash
RABBIT_URL="amqp://delorenj:Ittr5eesol@localhost:5673/" uv run python /tmp/test_meeting_trigger.py
```
